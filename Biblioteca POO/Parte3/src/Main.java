...
public class Main {
    ...
    private static void menuFuncionario(int opcao) throws IOException {
        switch (opcao) {
            case 1:
                cadastrarLivro();
                break;
    ...
    private static void menuUsuarios(int opcao) throws IOException {
        switch (opcao) {
            case 1:
                listarLivros();
                break;
    ...
    private static void cadastrarUsuario() {
        ...
        switch (tipo) {
            case 1:
                ...
                scanner.nextLine();
                usuario = new Estudante(id, nome, idade, sexo, telefone, curso, anoIngresso, cpf);
                break;
            case 2:
                ...
                usuario = new Professor(id, nome, idade, sexo, telefone, departamento, especializacao, cpf);
                break;
            case 3:
                ...
                usuario = new Funcionario(id, nome, idade, sexo, telefone, setor, cargo, cpf);
                break;
            default:
