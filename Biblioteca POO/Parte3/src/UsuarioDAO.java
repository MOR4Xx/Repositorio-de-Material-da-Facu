...
public class UsuarioDAO implements DAO<Usuario> {
    ...
    private static final String BASE_PATH = "Biblioteca POO/Parte 3/Usuarios/";

    @Override
    public void salvar(Usuario usuario) {
        try {
            File filenew = new File(BASE_PATH + usuario.getId() + ".txt");
    ...
    private Usuario createUserFromData(String[] data) {
        ...
        switch (tipo) {
            case "Aluno":
                ...
                return new Estudante(id, nome, idade, sexo, telefone, curso, anoDeIngresso, cpf);
            case "Professor":
                String departamento = data[6];
                String especializacao = data[7];
                return new Professor(id, nome, idade, sexo, telefone, departamento, especializacao, cpf);
            case "Funcionario":
                String setor = data[6];
                String cargo = data[7];
                return new Funcionario(id, nome, idade, sexo, telefone, setor, cargo, cpf);
            default:
                return null;
        }
    }
